...
| printable | insert char at gap, increment `ed_cur_col`.  Typing `:` at end of line also strips the leading $A0 (label slides to column 0 in real time). | current row only + status |
